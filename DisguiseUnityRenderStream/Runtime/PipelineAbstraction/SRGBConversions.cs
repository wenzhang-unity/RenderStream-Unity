...
namespace Disguise.RenderStream
{
    ...
    static class SRGBConversions
    {
        ...
        public static Texture GetTextureFormat(UnityEngine.Texture texture)
        {
            return GetTextureFormat(texture.graphicsFormat);
        }
        ...
        /// </summary>
        public static Descriptor GetAutoDescriptor(UnityEngine.Texture texture)
        {
            return GetAutoDescriptor(texture.graphicsFormat);
        }
        
        /// <inheritdoc cref="GetAutoDescriptor(UnityEngine.Texture)"/>
